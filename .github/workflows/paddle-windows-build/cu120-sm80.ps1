...
cmake .. -GNinja -DWITH_MKL=ON -DWITH_GPU=ON -DON_INFER=ON -DWITH_PYTHON=OFF -DWITH_UNITY_BUILD=ON -DCUDA_ARCH_NAME=Manual -DCUDA_ARCH_BIN="80" -DCMAKE_CUDA_ARCHITECTURES="80" -DWITH_ONNXRUNTIME=ON -DWITH_TENSORRT=ON -DTENSORRT_ROOT="C:\cu120"
ninja all
